...
export const GET_MENU_ITEMS_BY_RESTAURANT_ID__REQUEST = 'GET_MENU_ITEMS_BY_RESTAURANT_ID__REQUEST';
export const GET_MENU_ITEMS_BY_RESTAURANT_ID__SUCCESS = 'GET_MENU_ITEMS_BY_RESTAURANT_ID__SUCCESS';
export const GET_MENU_ITEMS_BY_RESTAURANT_ID__FAILURE = 'GET_MENU_ITEMS_BY_RESTAURANT_ID__FAILURE';
