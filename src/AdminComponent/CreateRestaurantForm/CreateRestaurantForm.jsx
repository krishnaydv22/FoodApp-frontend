...
import { createRestaurantApi } from '../../Components/State/Restaurant/Action';
...
const initialValues = {
  ...
  twitter:"",
  instagram:"",
  openingHours:"Mon-Sun 9:00 AM - 12 PM",
  images:[]
...
const CreateRestaurantForm = () => {
 ...
 dispatch(createRestaurantApi({data,jwt}));
  ...
  return (
    ...
    <form onSubmit= { formik.handleSubmit} className='space-y-4'>
       ...
       <label className="relative cursor-pointer" htmlFor="fileInput">
        <span className="w-24 h-24 cursor-pointer flex items-center justify-center p-3 
